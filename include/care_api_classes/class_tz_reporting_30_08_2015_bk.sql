        ...
        switch($admission){
	          case 1:
	               if($_POST['current_ward_nr']=='all_ipd'){
			           $in_out_patient='AND encounter_class_nr=1';
			           $in_out_where='WHERE encounter_class_nr=1';
			        }  else{
	                   $in_out_patient= 'AND current_ward_nr='.$_POST['current_ward_nr'];
	                   $in_out_where='WHERE current_ward_nr='.$_POST['current_ward_nr'];
	                  }
	                break;
	          case 2:
	               if($_POST['dept_nr']=='all_opd'){
			           $in_out_patient='AND encounter_class_nr=2';
			           $in_out_where='WHERE encounter_class_nr=2';
			        }   else{
			            $in_out_patient='AND current_dept_nr='.$_POST['dept_nr'];
			            $in_out_where='WHERE current_dept_nr='.$_POST['dept_nr'];	 
				        }	   
	                 break;
	          default:
	                     $in_out_patient='';
