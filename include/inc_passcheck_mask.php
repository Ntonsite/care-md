...
<input type="hidden" name="target" value="'.isset($target).'">
<input type="hidden" name="subtarget" value="'.isset($subtarget).'">
<input type="hidden" name="user_origin" value="'.isset($user_origin).'">
<input type="hidden" name="title" value="'.isset($title).'">
<input type="hidden" name="fwd_nr" value="'.isset($fwd_nr).'">';
