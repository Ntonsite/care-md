...
if (!array_key_exists('sess_path_referer', $_SESSION)) {
...
if ($_POST['hospNo']) {
    ...
    #Get NHIF number validation status
    $nhif_status = $nb->_validate_nhif_status();
}
?>
				...
				<td align="left" colspan="2"><FONT  color="#0000cc"><b>' . $LDHospitalFNr . '</b><br />' .
					  ...
					  ' . $LDOFNr . '</label>' .
						...
						<td  style="width:10%; text-align:center;">' .
                            ...
                            echo '<tr>
						<td style="width:10%; text-align:center;"><img ' . createComIcon($root_path, 'post_discussion.gif', '0') . '></td>
						<td><FONT  color="#0000cc"><b>Validate ' . $LDpNHIF . '</b> </FONT></td>
						<td  style="width:10%; text-align:center;">' .
                            '<input type="checkbox" name="validate_nhif" ';
                            if ($nhif_status == 1)
                                print ' checked="true" ';
                            echo ' value="1" >
			       </td>
